...
{
    public partial class FrmEstoqueProdutoCadastrar : Form
    {
        public FrmEstoqueProdutoCadastrar()
        {
            InitializeComponent();
        }

        private void FrmEstoqueProdutoCadastrar_Load(object sender, EventArgs e)
        {
